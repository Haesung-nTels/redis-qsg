...
func isDialError(err error) bool {
	return strings.HasPrefix(err.Error(), "dial")
}

func isConnRefused(err error) bool {
	return isDialError(err) && strings.HasSuffix(err.Error(), "connection refused")
}

func isIOError(err error) bool {
	return isDialError(err) && strings.HasSuffix(err.Error(), "i/o timeout")
}
